...
def _single_bootstrap_to_disk(
    ...
    # Compute results
    bootstrap_result_sample_dict, downsampled_df_sample_dict = (
    ...
    with open(
        os.path.join(
            output_dir,
            f"bootstrap_{bootstrap_idx}_downsampled_mol_infos_at_different_depths.dill",
        ),
        "wb",
    ) as f:
    ...
    with open(
        os.path.join(
            output_dir, f"bootstrap_{bootstrap_idx}_stats_at_different_depths.dill"
        ),
        "wb",
    ) as f:
